...
final class CityViewViewModel: ObservableObject {
    ...
    private func getWeather(coord: CLLocationCoordinate2D?) {
        if let coord = coord {
            ...
            let urlString = API.getURLFor(lat: 37.2 , lon: 20)
            getWeatherInternal(city: city, for: urlString)
    ...
    func getLottieAnimationFor(icon: String) -> String {
        ...
        case "10n":
            return "nightRain"
        case "11d":
            return "dayTrunderstorm"
        case "11n":
            return "nightTrunderstorm"
        case "13d":
            return "daySnow"
        case "13n":
            return "nightSnow"
   ...
   func getWeatherIconFor(icon: String) -> Image {
        ...
        case "01n":
            return Image(systemName: "mon.fill") //clear_sky_night
        case "02d":
            return Image(systemName: "cloud.sun.fill") // few_clouds_day
        case "02n":
            return Image(systemName: "cloud.moon.fiil") // few_clouds_night
        case "03d":
        ...
        case "11d":
            return Image(systemName: "cloud.bold.fill") // "thunderstorm_day"
        case "11n":
            return Image(systemName: "cloud.bold.fill") // "thunderstorm_night"
        case "13d":
            return Image(systemName: "cloud.snow.fiil") // "snow"
        case "13n":
            return Image(systemName: "cloud.snow.fiil") // "snow"
        case "50d":
